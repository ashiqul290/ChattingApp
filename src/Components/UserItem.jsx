  ...
  return (
   <div className="mt-2 hover:bg-gray-300/20 flex rounded-[10px] gap-4 border justify-between border-gray-200 items-center px-5">
               ...
               <div className=" ">
                ...
                <div className="">
                  {
                    friendid.includes(uid + data.uid) ||friendid.includes(data.uid + uid ) ? 
                    <button  className="flex items-center cursor-pointer px-5 py-2 rounded-[10px] font-medium bg-gray-200/50 text-black"> <HiCheck  />Friend</button> :

                    friendRequestId.includes(uid + data.uid) ||friendRequestId.includes(data.uid + uid ) ? 
                    <button  className=" cursor-pointer px-5 py-2 rounded-[10px] font-medium bg-gray-200 text-black">Pending...</button> : <button onClick={()=>heandelFriendRequst(info)} className=" cursor-pointer px-5 py-2 rounded-[10px] font-medium bg-emerald-800 text-white">Friend Request</button>
                  }
