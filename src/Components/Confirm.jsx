      ...
      <div className="mt-2 hover:bg-gray-300/20 flex rounded-[10px] gap-4 border justify-between border-gray-200 items-center px-5">
        <div className="flex items-center gap-2">
          ...
          <div className=" ">
            ...
            <h2 className="font-medium text-gray-600">{detail.senderemail}</h2>
          </div>
        </div>
        <div className="">
          <button
            onClick={() => heandeleConfirm(detail)}
            className="cursor-pointer px-5 py-2 rounded-[10px] font-medium bg-emerald-700 text-white"
          >
            Confirm
          </button>
          <button
            onClick={() => heandeleDelete(detail)}
            className="cursor-pointer px-5 ml-5 py-2 rounded-[10px] font-bold bg-white shadow-[0_0_3px] shadow-gray-500 text-gray-700 "
          >
            Delete
          </button>
        </div>
