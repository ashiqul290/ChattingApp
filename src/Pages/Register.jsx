        ...
        <div className="space-y-4">
          <div>
            ...
            onChange={haendlName}
              ...
              autoComplete="text"
              required=""
              className={`bg-gray-100 ${error.name ? 'placeholder:text-red-500 border-[1px] border-red-500 text-red-600' : 'text-gray-800'} font-medium w-full text-[18px] px-4 py-3 rounded-md bg-gray-200 
               outline-none`}
          ...
          <div>
            <input
             onChange={haendlEmail}
              ...
              autoComplete="email"
              required=""
               className={`bg-gray-100 ${error.email ? 'placeholder:text-red-500 border-[1px] border-red-500 text-red-600' : 'text-gray-800'} font-medium w-full text-[18px] px-4 py-3 rounded-md bg-gray-200 outline-none`}
          ...
          <div className=' relative'>
            <input
             onChange={haendlPwd}
              ...
              required=""
               className={`bg-gray-100 ${error.pwd ? 'placeholder:text-red-500 border-[1px] border-red-500 text-red-600' : 'text-gray-800'}  font-medium w-full text-[18px] px-4 py-3 rounded-md bg-gray-200 outline-none`}
              placeholder="Password...."
            />
            <span className={`text-[14px] ${error.pwd ? 'text-red-500 ' : 'text-gray-600'}  font-medium ml-2`}>6–20 chars, number, upper & lower.</span>
          {
            show ? <FaRegEye onClick={heandleHide} className=' text-[20px] absolute right-3 top-4'/>
