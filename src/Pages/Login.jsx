...
function Login() {
  return (
    <>
    <div className="bg-gradient-to-r from-purple-900 via-purple-800 to-purple-600">
  <div className="min-h-screen flex fle-col items-center justify-center p-6">
    <div className="grid md:grid-cols-2 items-center gap-10 max-w-6xl w-full">
      <div className="max-w-lg max-md:mx-auto max-md:text-center">
        ...
        <p className="text-[15px] mt-6 text-white leading-relaxed">
      ...
      <form className="bg-white rounded-xl px-8 py-12 max-w-md md:ml-auto max-md:mx-auto w-full">
